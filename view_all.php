<?php
  ...
  $sql = "SELECT id, title, description, created_at FROM topics";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container">
      <br/><br/>
      <h1 style="text-align:center">List of all topics</h1>
      <br/><br/>
...
<tbody>
  ...
  <?php
    ...
    echo "<td><a href='./details.php?id=".$row['id']."'>Comment</a>"."</td>";
  ?>
  </tr>
<?php } ?>
<?php } else {
